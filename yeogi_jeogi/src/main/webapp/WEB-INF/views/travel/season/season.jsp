...
<head>
    ...
    <link rel="stylesheet" href="/css/travel/season/season.css">
...
<body>
    ...
    <div id="container">
       <div class="menu">
            <ul>
                <li><a href="/product/region/50201">지역별 여행</a></li>
       ...
       <div class="season">
            <ul>
                <li><a href="/product/season/5040001">봄</a></li>
                <li><a href="">여름</a></li>
                <li><a href="">가을</a></li>
                <li><a href="/product/season/5040028">겨울</a></li>
            </ul>
        </div>
        <br>
        <hr class="type1">
        ...
        <div class="content">
            <div class="content">
        	<c:forEach var="tList" items="${seasonTravelList}" varStatus="status">
	            <div id="img1">
	                <img src="${sList.gettImgAdd()}">
	                <div id="img">
                       <div>
                       	<img src="/images/region/찜.png" width="15px"> ${sList.gettRcm()} &nbsp; 
                        <img src="/images/region/조회수.png" width="15px"> ${sList.gettCount()} &nbsp;
                        <img src="/images/region/댓글.png" width="15px"> -- 
                       </div>
	                   <h3>${sList.gettRegionName()}</h3>
	                   <p>${sList.gettName()}</p>
	                </div>
	            </div>
            </c:forEach>
    ...
    <script src="/js/travel/season.js"></script>
  </div>
</body>
</html>